...
export default function AddStatusesForm({ closeModal }: { closeModal: () => void }) {
  const { addStatuses, loading: statusesLoading } = useStatuses(); // 🔥 Menggunakan hook priority
  ...
  const handleFormSubmit = async () => {
    ...
    const result = await addStatuses(formData);
