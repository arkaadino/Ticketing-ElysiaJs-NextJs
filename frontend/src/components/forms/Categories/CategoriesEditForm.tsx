...
export default function EditCategoriesForm({id, initialData, closeModal }: {id: string; initialData: any; closeModal: () => void }) {
  const { updateCategories, loading: categoriesLoading } = useCategories(); // 🔥 Menggunakan hook priority
  ...
  const handleFormSubmit = async () => {
    ...
    const success = await updateCategories(id, formData);
